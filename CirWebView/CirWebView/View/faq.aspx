<%@ Page Title="" Language="C#" MasterPageFile="~/View/Master.Master" AutoEventWireup="true" CodeBehind="faq.aspx.cs" Inherits="CirWebView.View.faq" %>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 text-center">
						<h2 class="title">As respostas acima não ajudaram?</h2>
						<h4>Nos envie uma mensagem</h4>
						<a href="contact-us.aspx" class="btn btn-primary">Contate-nos</a>
					</div>
				</div><!-- row -->
			</div><!-- contaioner -->
